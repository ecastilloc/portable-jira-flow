...
description: Opt-in behavior-contract pilot for portable-jira-flow. Use when the user invokes portable-jira-flow-v2 for doctor, inspect, status, or shadow planning against the same configured local profiles as portable-jira-flow.
---
...
portable-jira-flow-v2 inspect ABC-123
portable-jira-flow-v2 status ABC-123
```
